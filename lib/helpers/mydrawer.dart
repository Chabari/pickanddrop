...
import 'package:pickaanddrop/helpers/homedrawer.dart';
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(
                          color: primaryColor.withOpacity(0.8), blurRadius: 24),
                    ],
                  ),
                  child: Stack(
                    children: <Widget>[
                      ...
                      if(widget.isHide == false)
                        Padding(
                          padding: EdgeInsets.only(
                              top: MediaQuery.of(context).padding.top + 8,
                              left: 8),
                          child: SizedBox(
                            width: AppBar().preferredSize.height - 15,
